...
namespace HOL_2_MVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            if (!System.IO.File.Exists(@"C:\Users\KeerthiReddyVM\Downloads\VM.jpg"))
            {
                return Content("File to be downloaded not found");
            }
            return File(@"C:\Users\KeerthiReddyVM\Downloads\VM.jpg", "image/jpg", "default.jpg");
        }
